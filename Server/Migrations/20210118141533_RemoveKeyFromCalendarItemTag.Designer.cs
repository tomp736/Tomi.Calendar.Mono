...
namespace Tomi.Calendar.Mono.Server.Migrations
{
    ...
    [Migration("20210118141533_RemoveKeyFromCalendarItemTag")]
    partial class RemoveKeyFromCalendarItemTag
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tomi.Calendar.Mono.Shared.CalendarItem", b =>
                {
                    b.Property<int>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Tomi.Calendar.Mono.Shared.CalendarItemTag", b =>
                {
            ...
            modelBuilder.Entity("Tomi.Calendar.Mono.Shared.Tag", b =>
                {
                    b.Property<int>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Tomi.Calendar.Mono.Shared.CalendarItemTag", b =>
                {
                    b.HasOne("Tomi.Calendar.Mono.Shared.CalendarItem", "CalendarItem")
                        .WithMany("CalendarItemTags")
                        .HasForeignKey("CalendarItemKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tomi.Calendar.Mono.Shared.Tag", "Tag")
                        .WithMany("CalendarItemTags")
